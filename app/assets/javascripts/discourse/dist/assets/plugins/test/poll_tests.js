define("discourse/plugins/poll/acceptance/poll-breakdown-test", ["discourse/tests/helpers/qunit-helpers", "discourse/controllers/composer", "qunit", "@ember/test-helpers"], function (_qunitHelpers, _composer, _qunit, _testHelpers) {
  "use strict";

  0; //eaimeta@70e063a35619d71f0,"discourse/tests/helpers/qunit-helpers",0,"discourse/controllers/composer",0,"qunit",0,"@ember/test-helpers"eaimeta@70e063a35619d71f
  ...
  (0, _qunitHelpers.acceptance)("Poll breakdown", function (needs) {
    ...
    (0, _qunit.test)("Displaying the poll breakdown modal", async function (assert) {
      ...
      assert.ok((0, _qunitHelpers.exists)(".poll-show-breakdown"), "shows the breakdown button when poll_groupable_user_fields is non-empty");
      await (0, _testHelpers.click)(".poll-show-breakdown");
...
define("discourse/plugins/poll/acceptance/poll-builder-disabled-test", ["discourse/tests/helpers/qunit-helpers", "discourse/controllers/composer", "discourse/plugins/poll/helpers/display-poll-builder-button", "qunit"], function (_qunitHelpers, _composer, _displayPollBuilderButton, _qunit) {
  "use strict";

  0; //eaimeta@70e063a35619d71f0,"discourse/tests/helpers/qunit-helpers",0,"discourse/controllers/composer",0,"discourse/plugins/poll/helpers/display-poll-builder-button",0,"qunit"eaimeta@70e063a35619d71f
...
define("discourse/plugins/poll/acceptance/poll-builder-enabled-test", ["discourse/tests/helpers/qunit-helpers", "discourse/controllers/composer", "discourse/plugins/poll/helpers/display-poll-builder-button", "qunit"], function (_qunitHelpers, _composer, _displayPollBuilderButton, _qunit) {
  "use strict";
  ...
  (0, _qunitHelpers.acceptance)("Poll Builder - polls are enabled", function (needs) {
    ...
    (0, _qunit.test)("regular user - sufficient trust level", async function (assert) {
      ...
      await (0, _displayPollBuilderButton.displayPollBuilderButton)();
      assert.ok((0, _qunitHelpers.exists)(".select-kit-row[data-value='showPollBuilder']"), "it shows the builder button");
    });
    (0, _qunit.test)("regular user - insufficient trust level", async function (assert) {
      (0, _qunitHelpers.updateCurrentUser)({
        moderator: false,
...
define("discourse/plugins/poll/acceptance/poll-in-reply-history-test", ["discourse/tests/helpers/qunit-helpers", "discourse/controllers/composer", "qunit", "@ember/test-helpers"], function (_qunitHelpers, _composer, _qunit, _testHelpers) {
  "use strict";
  ...
  (0, _qunitHelpers.acceptance)("Poll in a post reply history", function (needs) {
    ...
    needs.hooks.beforeEach(() => {
      (0, _composer.clearPopupMenuOptionsCallback)();
    });
    needs.pretender((server, helper) => {
...
define("discourse/plugins/poll/acceptance/poll-pie-chart-test", ["discourse/tests/helpers/qunit-helpers", "qunit", "@ember/test-helpers"], function (_qunitHelpers, _qunit, _testHelpers) {
  "use strict";
...
define("discourse/plugins/poll/acceptance/poll-quote-test", ["discourse/tests/helpers/qunit-helpers", "discourse/controllers/composer", "qunit", "@ember/test-helpers"], function (_qunitHelpers, _composer, _qunit, _testHelpers) {
  "use strict";
...
define("discourse/plugins/poll/acceptance/poll-results-test", ["discourse/tests/helpers/qunit-helpers", "qunit", "discourse/controllers/composer", "@ember/test-helpers"], function (_qunitHelpers, _qunit, _composer, _testHelpers) {
  "use strict";

  0; //eaimeta@70e063a35619d71f0,"discourse/tests/helpers/qunit-helpers",0,"qunit",0,"discourse/controllers/composer",0,"@ember/test-helpers"eaimeta@70e063a35619d71f
  ...
  (0, _qunitHelpers.acceptance)("Poll results", function (needs) {
    ...
    (0, _qunit.test)("can load more voters", async function (assert) {
      await (0, _testHelpers.visit)("/t/-/load-more-poll-voters");
  ...
  (0, _qunitHelpers.acceptance)("Poll results - no voters", function (needs) {
    ...
    (0, _qunit.test)("disables show results button", async function (assert) {
      await (0, _testHelpers.visit)("/t/-/load-more-poll-voters");
      assert.ok((0, _qunitHelpers.query)(".toggle-results").disabled);
    });
  });
});
define("discourse/plugins/poll/acceptance/polls-bar-chart-test-desktop", ["discourse/tests/helpers/qunit-helpers", "discourse/controllers/composer", "qunit", "@ember/test-helpers"], function (_qunitHelpers, _composer, _qunit, _testHelpers) {
  "use strict";
...
define("discourse/plugins/poll/acceptance/polls-bar-chart-test-mobile", ["discourse/tests/helpers/qunit-helpers", "discourse/controllers/composer", "qunit", "@ember/test-helpers"], function (_qunitHelpers, _composer, _qunit, _testHelpers) {
  "use strict";
...
define("discourse/plugins/poll/controllers/poll-ui-builder-test", ["discourse/tests/helpers/qunit-helpers", "discourse/plugins/poll/controllers/poll-ui-builder", "qunit", "@ember/test-helpers"], function (_qunitHelpers, _pollUiBuilder, _qunit, _testHelpers) {
  "use strict";

  0; //eaimeta@70e063a35619d71f0,"discourse/tests/helpers/qunit-helpers",0,"discourse/plugins/poll/controllers/poll-ui-builder",0,"qunit",0,"@ember/test-helpers"eaimeta@70e063a35619d71f
  ...
  (0, _qunitHelpers.discourseModule)("Unit | Controller | poll-ui-builder", function () {
    (0, _qunit.test)("isMultiple", function (assert) {
      const controller = setupController(this);
      controller.setProperties({
        pollType: _pollUiBuilder.MULTIPLE_POLL_TYPE,
        pollOptions: [{
          value: "a"
        }]
      });
    ...
    (0, _qunit.test)("isNumber", function (assert) {
      const controller = setupController(this);
      controller.set("pollType", _pollUiBuilder.REGULAR_POLL_TYPE);
      assert.strictEqual(controller.isNumber, false, "it should be false");
      controller.set("pollType", _pollUiBuilder.NUMBER_POLL_TYPE);
      assert.strictEqual(controller.isNumber, true, "it should be true");
    });
    (0, _qunit.test)("pollOptionsCount", function (assert) {
      const controller = setupController(this);
    ...
    (0, _qunit.test)("disableInsert", function (assert) {
      const controller = setupController(this);
      ...
      assert.strictEqual(controller.disableInsert, false, "it should be false");
      controller.setProperties({
        pollType: _pollUiBuilder.REGULAR_POLL_TYPE,
        pollOptions: [{
          value: "a"
        }, {
          value: "b"
    ...
    (0, _qunit.test)("number pollOutput", async function (assert) {
      this.siteSettings.poll_maximum_options = 20;
      const controller = setupController(this);
      controller.setProperties({
        pollType: _pollUiBuilder.NUMBER_POLL_TYPE,
        pollMin: 1
      });
      await (0, _testHelpers.settled)();
      assert.strictEqual(controller.pollOutput, "[poll type=number results=always min=1 max=20 step=1]\n[/poll]\n", "it should return the right output");
      controller.set("pollStep", 2);
      await (0, _testHelpers.settled)();
      assert.strictEqual(controller.pollOutput, "[poll type=number results=always min=1 max=20 step=2]\n[/poll]\n", "it should return the right output");
      controller.set("publicPoll", true);
      assert.strictEqual(controller.pollOutput, "[poll type=number results=always min=1 max=20 step=2 public=true]\n[/poll]\n", "it should return the right output");
      controller.set("pollStep", 0);
      assert.strictEqual(controller.pollOutput, "[poll type=number results=always min=1 max=20 step=1 public=true]\n[/poll]\n", "it should return the right output");
    });
    (0, _qunit.test)("regular pollOutput", function (assert) {
      const controller = setupController(this);
      controller.siteSettings.poll_maximum_options = 20;
      controller.setProperties({
        pollOptions: [{
      ...
      assert.strictEqual(controller.pollOutput, "[poll type=regular results=always chartType=bar]\n* 1\n* 2\n[/poll]\n", "it should return the right output");
      controller.set("publicPoll", "true");
      assert.strictEqual(controller.pollOutput, "[poll type=regular results=always public=true chartType=bar]\n* 1\n* 2\n[/poll]\n", "it should return the right output");
      controller.set("pollGroups", "test");
      assert.strictEqual(controller.get("pollOutput"), "[poll type=regular results=always public=true chartType=bar groups=test]\n* 1\n* 2\n[/poll]\n", "it should return the right output");
    });
    (0, _qunit.test)("multiple pollOutput", function (assert) {
      const controller = setupController(this);
      controller.siteSettings.poll_maximum_options = 20;
      controller.setProperties({
        pollType: _pollUiBuilder.MULTIPLE_POLL_TYPE,
      ...
      assert.strictEqual(controller.pollOutput, "[poll type=multiple results=always min=1 max=2 chartType=bar]\n* 1\n* 2\n[/poll]\n", "it should return the right output");
      controller.set("publicPoll", "true");
      assert.strictEqual(controller.pollOutput, "[poll type=multiple results=always min=1 max=2 public=true chartType=bar]\n* 1\n* 2\n[/poll]\n", "it should return the right output");
    });
    (0, _qunit.test)("staff_only option is not present for non-staff", async function (assert) {
      ...
      assert.strictEqual(controller.pollResults.filterBy("value", "staff_only").length, 0, "staff_only is not present");
    });
    (0, _qunit.test)("poll result is always by default", function (assert) {
      const controller = setupController(this);
      assert.strictEqual(controller.pollResult, "always");
    });
    (0, _qunit.test)("staff_only option is present for staff", async function (assert) {
      const controller = setupController(this);
      controller.currentUser = {
        staff: true
      };
      controller.notifyPropertyChange("pollResults");
      assert.strictEqual(controller.pollResults.filterBy("value", "staff_only").length, 1, "staff_only is present");
    });
  });
});
define("discourse/plugins/poll/helpers/display-poll-builder-button", ["exports", "discourse/tests/helpers/select-kit-helper", "@ember/test-helpers"], function (_exports, _selectKitHelper, _testHelpers) {
  "use strict";
  ...
  0; //eaimeta@70e063a35619d71f0,"discourse/tests/helpers/select-kit-helper",0,"@ember/test-helpers"eaimeta@70e063a35619d71f
...
define("discourse/plugins/poll/widgets/discourse-poll-option-test", ["@ember/template-factory", "qunit", "discourse/tests/helpers/component-test", "@ember/test-helpers", "discourse/tests/helpers/qunit-helpers"], function (_templateFactory, _qunit, _componentTest, _testHelpers, _qunitHelpers) {
  "use strict";

  0; //eaimeta@70e063a35619d71f0,"qunit",0,"discourse/tests/helpers/component-test",0,"@ember/test-helpers",0,"discourse/tests/helpers/qunit-helpers",0,"htmlbars-inline-precompile"eaimeta@70e063a35619d71f
...
define("discourse/plugins/poll/widgets/discourse-poll-standard-results-test", ["@ember/template-factory", "qunit", "discourse/tests/helpers/component-test", "@ember/test-helpers", "@ember/object", "discourse/tests/helpers/qunit-helpers"], function (_templateFactory, _qunit, _componentTest, _testHelpers, _object, _qunitHelpers) {
  "use strict";

  0; //eaimeta@70e063a35619d71f0,"qunit",0,"discourse/tests/helpers/component-test",0,"@ember/test-helpers",0,"@ember/object",0,"discourse/tests/helpers/qunit-helpers",0,"htmlbars-inline-precompile"eaimeta@70e063a35619d71f
...
define("discourse/plugins/poll/widgets/discourse-poll-test", ["@ember/template-factory", "qunit", "discourse/tests/helpers/component-test", "@ember/test-helpers", "discourse/tests/helpers/qunit-helpers", "discourse/tests/helpers/create-pretender", "@ember/object", "I18n"], function (_templateFactory, _qunit, _componentTest, _testHelpers, _qunitHelpers, _createPretender, _object, _I18n) {
  "use strict";

  0; //eaimeta@70e063a35619d71f0,"qunit",0,"discourse/tests/helpers/component-test",0,"@ember/test-helpers",0,"discourse/tests/helpers/qunit-helpers",0,"htmlbars-inline-precompile",0,"discourse/tests/helpers/create-pretender",0,"@ember/object",0,"I18n"eaimeta@70e063a35619d71f
  ...
  (0, _qunit.module)("Integration | Component | Widget | discourse-poll", function (hooks) {
    ...
    */
    {
      "id": "1iLqN9BB",
      "block": "[[[1,\"\\n    \"],[8,[39,0],null,[[\"@widget\",\"@args\"],[\"discourse-poll\",[28,[37,1],null,[[\"id\",\"post\",\"poll\",\"vote\",\"groupableUserFields\"],[[30,0,[\"id\"]],[30,0,[\"post\"]],[30,0,[\"poll\"]],[30,0,[\"vote\"]],[30,0,[\"groupableUserFields\"]]]]]]],null],[1,\"\\n  \"]],[],false,[\"mount-widget\",\"hash\"]]",
      "moduleName": "(unknown template module)",
      "isStrictMode": false
    });
    (0, _qunit.test)("can vote", async function (assert) {
      ...
      assert.strictEqual((0, _qunitHelpers.query)(".chosen").innerText, "100%yes");
      await (0, _testHelpers.click)(".toggle-results");
    ...
    (0, _qunit.test)("cannot vote if not member of the right group", async function (assert) {
      ...
      requests = 0;
      await (0, _testHelpers.click)("li[data-poll-option-id='1f972d1df351de3ce35a787c89faad29']");
      assert.strictEqual((0, _qunitHelpers.query)(".poll-container .alert").innerText, _I18n.default.t("poll.results.groups.title", {
        groups: "foo"
      }));
