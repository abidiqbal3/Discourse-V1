...
<span class="missing-if-branch" title="if path not taken" >I</span>if ($$diffHTML in globalThis) {
  const existingApi = <span class="cstat-no" title="statement not covered" >global[$$diffHTML];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (VERSION !== existingApi.VERSION) {</span>
<span class="cstat-no" title="statement not covered" >    console.log(`Loaded ${VERSION} after ${existingApi.VERSION}`);</span>
  }
}
&nbsp;
global[$$diffHTML] = api;
