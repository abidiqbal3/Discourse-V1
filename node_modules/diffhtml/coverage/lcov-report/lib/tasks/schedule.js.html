...
&nbsp;
    ...
    else <span class="cstat-no" title="statement not covered" >if (oldMount === newMount) {</span>
...
&nbsp;
    ...
    transaction.abort();
&nbsp;
    const promise = nextTransaction &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >nextTransaction.promise </span>|| activeTransaction.promise || Promise.resolve();
&nbsp;
