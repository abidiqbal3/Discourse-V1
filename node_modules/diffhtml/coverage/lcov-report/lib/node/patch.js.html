    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>169/173</span>
            </div>
...
<a name='L432'></a><a href='#L432'>432</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (lowerName) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isEvent) {
<span class="cstat-no" title="statement not covered" >      anyNode[name] = undefined;</span>
    } else {
      delete anyNode[name];
    }
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!domNode) {
...
&nbsp;
        ...
        if (!hasAttached &amp;&amp; !hasDetached &amp;&amp; !hasReplaced) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (oldDomNode.parentNode) {
...
&nbsp;
        if (detachedPromises.length) {
          Promise.all(detachedPromises).then(() =&gt; {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (domNode.parentNode) {
