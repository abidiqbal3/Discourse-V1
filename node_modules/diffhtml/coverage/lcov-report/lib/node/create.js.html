...
&nbsp;
  const {
    nodeName,
    rawNodeName = <span class="branch-0 cbranch-no" title="branch not covered" >nodeName,</span>
    childNodes = /** @type {VTree[]} */ (<span class="branch-0 cbranch-no" title="branch not covered" >[])</span>,
  } = vTree;
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!ownerDocument) {
