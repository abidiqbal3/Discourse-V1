...
function serializeVTree(vTree) {
  let output = '';
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!vTree) {
...
&nbsp;
  ...
  else <span class="missing-if-branch" title="else path not taken" >E</span>if (childNodes.length) {
