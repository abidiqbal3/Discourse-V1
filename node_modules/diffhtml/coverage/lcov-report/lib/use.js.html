...
&nbsp;
  ...
  subscribe &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >subscribe(Internals);</span>
&nbsp;
  ...
  parseHook &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >ParseHookCache.add(parseHook);</span>
&nbsp;
...
&nbsp;
    ...
    // to cleanup).
    unsubscribe &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >unsubscribe(Internals);</span>
&nbsp;
    ...
    parseHook &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >ParseHookCache.delete(parseHook);</span>
  };
}
&nbsp;</pre></td></tr></table></pre>
