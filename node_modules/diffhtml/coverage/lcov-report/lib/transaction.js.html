...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2173x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    const hasObserver = 'MutationObserver' in (globalThis.window || <span class="branch-1 cbranch-no" title="branch not covered" >EMPTY.OBJ)</span>;
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (mountAsHTMLEl.ownerDocument &amp;&amp; state.mutationObserver) {
...
<span class="cstat-no" title="statement not covered" >      state.isDirty = true;</span>
    }
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!oldNode) {
...
&nbsp;
     ...
     // current allocation.
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Pool.memory.free.size &lt; Pool.memory.allocated.size * 2) {
