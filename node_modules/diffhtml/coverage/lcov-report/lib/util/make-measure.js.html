...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import getConfig from "./config";
...
&nbsp;
    if (marks.has(name)) {
      const prevMark = marks.get(name) || <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
