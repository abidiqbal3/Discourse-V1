...
<span class="cstat-no" title="statement not covered" >      return valueAsString;</span>
    }
&nbsp;
<span class="branch-2 cbranch-no" title="branch not covered" >    case 'number': {</span>
<span class="cstat-no" title="statement not covered" >      return parseInt(valueAsString, 10);</span>
    }
&nbsp;
<span class="branch-3 cbranch-no" title="branch not covered" >    case 'array': {</span>
<span class="cstat-no" title="statement not covered" >      return valueAsString.split(',');</span>
    }
&nbsp;
<span class="branch-4 cbranch-no" title="branch not covered" >    case 'object': {</span>
<span class="cstat-no" title="statement not covered" >      return parse(valueAsString);</span>
    }
  }
}
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (useSearchParams) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (useEnv &amp;&amp; keyName in process.env) {
<span class="cstat-no" title="statement not covered" >    return formatValue(process.env[keyName], type);</span>
  }
&nbsp;
  return defaultValue;
}</pre></td></tr></table></pre>
