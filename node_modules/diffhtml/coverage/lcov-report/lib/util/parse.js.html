    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>212/234</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>213/227</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2522x</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (name === '') {
      const match = <span class="cstat-no" title="statement not covered" >rawAttrs.match(tokenEx);</span>
...
&nbsp;
          ...
          if (attributes[newName]) {
            attributes[newName] += value in supplemental.attributes ? supValue : <span class="branch-1 cbranch-no" title="branch not covered" >fallback;</span>
          }
          ...
          if (index === -1 &amp;&amp; options.parser.strict &amp;&amp; !selfClosing.has(name)) {
            ...
            const markup = html
              ...
              .map(line =&gt; line.replace(tokenEx, (value, index) =&gt; {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!supplemental) {
<span class="cstat-no" title="statement not covered" >                  return value;</span>
                }
&nbsp;
                const { tags, children, attributes } = supplemental;
                return tags[index] || <span class="branch-1 cbranch-no" title="branch not covered" >children[index] </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >attributes[index];</span>
              }))
              .slice(0, 3);
&nbsp;
            ...
            const caret = Array(
              (lookup ? lookup.index - 1 : <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> + closeMarkup.length - 1
            ).join(' ') + '^';
&nbsp;
...
&nbsp;
    if (match[1] || match[4] || selfClosing.has(name)) {
      if (process.env.NODE_ENV !== 'production') {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (currentParent &amp;&amp; name !== currentParent.rawNodeName &amp;&amp; options.parser.strict) {
          const nodeName = <span class="cstat-no" title="statement not covered" >currentParent.rawNodeName;</span>
&nbsp;
          // Find a subset of the markup passed in to validate.
          const markup = <span class="cstat-no" title="statement not covered" >html</span>
            .slice(tagEx.lastIndex - match[0].length)
            .split('\n')
            .map(<span class="fstat-no" title="function not covered" >li</span>ne =&gt; <span class="cstat-no" title="statement not covered" >line.replace(tokenEx, <span class="fstat-no" title="function not covered" >(v</span>alue, index) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >              if (!supplemental) {</span>
<span class="cstat-no" title="statement not covered" >                return value;</span>
              }
&nbsp;
              const { tags, children, attributes } = <span class="cstat-no" title="statement not covered" >supplemental;</span>
<span class="cstat-no" title="statement not covered" >              return tags[index] || children[index] || attributes[index];</span>
            }))
            .slice(0, 3);
&nbsp;
          // Position the caret next to the first non-whitespace character.
          const lookup = <span class="cstat-no" title="statement not covered" >spaceEx.exec(markup[0]);</span>
          const caret = <span class="cstat-no" title="statement not covered" >Array(lookup ? lookup.index : 0).join(' ') + '^';</span>
&nbsp;
          // Craft the warning message and inject it into the markup.
...
&nbsp;
      // Position the caret next to the first non-whitespace character.
      const lookup = spaceEx.exec(markup[0]);
      const caret = Array(lookup ? lookup.index : <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>.join(' ') + '^';
&nbsp;
      // Craft the warning message and inject it into the markup.
...
&nbsp;
      ...
      // Not a valid nested HTML tag element, move to respective container.
        ...
        else <span class="missing-if-branch" title="else path not taken" >E</span>if (!beforeBody) body.after.push(el);
      }
    });
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (headInstance) {
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (bodyInstance) {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sat May 01 2021 11:43:57 GMT-0700 (Pacific Daylight Time)
            </div>
        </div>
