...
api.toString = _toString.default;
...
if (_symbols.$$diffHTML in _global.default) {
  const existingApi = global[_symbols.$$diffHTML];

  if (_version.__VERSION__ !== existingApi.VERSION) {
    console.log(`Loaded ${_version.__VERSION__} after ${existingApi.VERSION}`);
  }
}

global[_symbols.$$diffHTML] = api; // Automatically hook up to DevTools if they are present.
