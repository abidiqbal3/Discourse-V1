      ...
      case _types.PATCH_TYPE.INSERT_BEFORE:
        {
          ...
          let domNode =
          /** @type {HTMLElement} */
          _types.NodeCache.get(vTree); // Patching without an existing DOM Node is a mistake, so we should not
      ...
      case _types.PATCH_TYPE.REPLACE_CHILD:
        {
          ...
          const hasAttached = (_TransitionCache$get = _types.TransitionCache.get('attached')) === null || _TransitionCache$get === void 0 ? void 0 : _TransitionCache$get.size;
          const hasDetached = (_TransitionCache$get2 = _types.TransitionCache.get('detached')) === null || _TransitionCache$get2 === void 0 ? void 0 : _TransitionCache$get2.size;
          const hasReplaced = (_TransitionCache$get3 = _types.TransitionCache.get('replaced')) === null || _TransitionCache$get3 === void 0 ? void 0 : _TransitionCache$get3.size; // In the hot path, ensure we always use the fastest operation given
          ...
          const allPromises = [...(hasAttached && (0, _transition.runTransitions)('attached', newTree) || _types.EMPTY.ARR), ...(hasDetached && (0, _transition.runTransitions)('detached', oldTree) || _types.EMPTY.ARR), ...(hasReplaced && (0, _transition.runTransitions)('replaced', oldTree, newTree) || _types.EMPTY.ARR)];
