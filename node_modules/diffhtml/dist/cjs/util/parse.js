...
const interpolateChildNodes = (currentParent, markup, supplemental) => {
  ...
  for (let i = 0; i < parts.length; i++) {
    ...
    if (i % 2 === 1) {
      ...
      const isFragment = innerTree.nodeType === _types.NODE_TYPE.FRAGMENT;
...
function parse(html, supplemental, options = {}) {
  ...
  /** @type {string[]} */
  (0, _config.default)('rawElements', rawElementsDefaults, 'array', options.parser));
  const selfClosing = new Set(
  /** @type {string[]} */
  (0, _config.default)('selfClosingElements', selfClosingElementsDefaults, 'array', options.parser));
...
Possibly invalid markup. Opening tag was not properly closed.
  ...
  if (root.childNodes.length && root.childNodes[0].nodeName === 'html') {
    ...
    HTML.childNodes = HTML.childNodes.filter(el => {
      ...
      else if (el.nodeType === _types.NODE_TYPE.ELEMENT) {
