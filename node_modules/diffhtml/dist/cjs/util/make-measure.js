...
function makeMeasure(transaction) {
  ...
  /** @type {VTree} */
  input;
  const id = count++; // Marks will only be available if the user has requested they want to collect
  // metrics.

  if (!(0, _config.default)('collectMetrics', false)) {
    return nop;
  }
  ...
  return name => {
    ...
    /** @type {any} */
    mount; // Use the Web Component name if it's available.
