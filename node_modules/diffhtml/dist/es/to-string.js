...
import { TransactionConfig, ValidInput, VTree, VTreeAttributes } from "./util/types.js";
...
export default function toString(input, config = {}) {
  ...
  const activeTasks = new Set(config.tasks || defaultTasks); // Replace the `endAsPromise` task with the string return value.
