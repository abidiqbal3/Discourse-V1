...
import { MiddlewareCache, StateCache, NodeCache, VTree, ValidInput, Mount, TransactionConfig, TransactionState, EMPTY } from "./util/types.js";
...
export default class Transaction {
  ...
  constructor(mount, input, config) {
    ...
    this.tasks =
    /** @type {Function[]} */
    getConfig('tasks', defaultTasks, undefined, config).slice(); // Store calls to trigger after the transaction has ended.
   ...
   */
    ...
    state.previousMarkup = 'outerHTML' in mountAsHTMLEl ? mountAsHTMLEl.outerHTML : EMPTY.STR; // Only execute scripts if the configuration is set. By default this is set
