import { StateCache, NODE_TYPE, VTree } from "../util/types.js";
...
export default function reconcileTrees(transaction) {
  ...
  state.oldTree.nodeType !== NODE_TYPE.FRAGMENT) {
    ...
    inputAsVTree.childNodes.forEach(value => {
      const isText = value.nodeType === NODE_TYPE.TEXT; // This is most likely the element that is requested to compare to. Will
