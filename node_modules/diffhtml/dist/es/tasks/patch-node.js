...
import { CreateNodeHookCache, VTree } from "../util/types.js";
...
export default function patch(transaction) {
  ...
  state.ownerDocument = ownerDocument || globalThis.document; // Always disconnect a MutationObserver before patching.
  ...
  CreateNodeHookCache.add(collectScripts); // Skip patching completely if we aren't in a DOM environment.
