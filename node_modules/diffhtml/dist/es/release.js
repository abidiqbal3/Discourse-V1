...
import { StateCache, NodeCache, ReleaseHookCache, Mount } from "./util/types.js";
/**
...
export default function release(mount) {
  ...
  if (StateCache.has(mount)) {
    const {
      mutationObserver,
      oldTree
    } = StateCache.get(mount); // Ensure the mutation observer is cleaned up.

    mutationObserver && mutationObserver.disconnect();
    StateCache.delete(mount); // If there is a known root association that is not in the NodeCache,
    // remove this VTree.
