...
import { TransitionCache, NodeCache, NODE_TYPE, VTree, TransitionStateNames, TransitionStateName } from "./util/types.js";
/**
 *
...
export function runTransitions(setName, ...args) {
  ...
  const vTree = args[0];
  const isElement = vTree.nodeType === NODE_TYPE.ELEMENT; // Filter out text nodes and fragments from transition callbacks.
  ...
  set.forEach(callback => {
    ...
    const retVal = callback(...nodes); // Is a `thennable` object or Native Promise.
