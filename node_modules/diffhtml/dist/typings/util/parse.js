...
export default function parse(html, supplemental, options = {}) {
    ...
    /** @type {string[]} */ (getConfig('rawElements', rawElementsDefaults, 'array', options.parser)));
    const selfClosing = new Set(
    /** @type {string[]} */ (getConfig('selfClosingElements', selfClosingElementsDefaults, 'array', options.parser)));
