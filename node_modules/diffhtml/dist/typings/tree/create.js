...
import { EMPTY, NODE_TYPE, NodeCache, CreateTreeHookCache, } from '../util/types';
const { isArray } = Array;
const { memory } = Pool;
...
export default function createTree(input, attributes, childNodes, ...rest) {
    ...
    if (input && isObject && 'ownerDocument' in inputAsHTMLEl) {
        ...
        entry.attributes = Object.assign(Object.assign({}, entry.attributes), attributes);
    ...
    if (attributes && typeof attributes === 'object' && !isArray(attributes)) {
        entry.attributes = Object.assign({}, attributes);
